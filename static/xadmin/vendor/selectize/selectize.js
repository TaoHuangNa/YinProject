...
(function(root, factory) {
	...
	$.extend(Selectize.prototype, {
		 ...
		 * an option in the autocomplete dropdown menus.
		 *
		 * @param {object} e
		 * @returns {boolean}
		 */
		 ...
		 * in the autocomplete dropdown menus.
		 *
		 * @param {object} e
		 * @returns {boolean}
		 */
		...
		/**
		 * Sets the selected item in the dropdown menus
		...
		addItem: function(value, silent) {
			...
			debounce_events(this, events, function() {
				...
				if (self.isSetup) {
					...
					// update menus / remove the option (if this is not one item being added as part of series)
					if (!self.isPending) {
					...
					// hide the menus if the maximum number of items have been selected or no options are left
		...
		/**
		 * Closes the autocomplete dropdown menus.
		 */
		close: function() {
			var self = this;
